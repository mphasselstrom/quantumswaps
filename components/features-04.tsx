      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">What You Need to Know</h2>
            <p className="text-lg text-slate-400">A comprehensive cross-chain solution with unmatched asset coverage, developer-friendly tools, and enterprise-grade reliability to power your Web3 applications.</p>
          </div>
          ...
          <div className="divide-y divide-slate-800">
            ...
            <div className="py-8 first-of-type:pt-0 last-of-type:pb-0">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-6">Wide Asset Coverage</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Seamless Cross-Chain</h4>
                  </div>
                  <p className="text-sm text-slate-400">Move assets across chains effortlessly with our optimized routing and bridging technology.</p>
                </div>
              </div>
            </div>
            {/* Row */}
            <div className="py-8">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-6">Built for Developers</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                {/* Feature */}
                <div>
                  ...
                  <p className="text-sm text-slate-400">Integrate our powerful swap functionality with simple, intuitive REST API endpoints.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                  ...
                  <p className="text-sm text-slate-400">Real-time notifications for all swap events with customizable webhook integrations.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Documentation</h4>
                  </div>
                  <p className="text-sm text-slate-400">Comprehensive guides, examples, and references to accelerate your integration.</p>
                </div>
              </div>
            </div>
            {/* Row */}
            <div className="py-8">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-6">Enterprise Ready</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                {/* Feature */}
                <div>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">World-Class Support</h4>
                  </div>
                  <p className="text-sm text-slate-400">Dedicated support team to ensure your success from integration to production.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">99.99% Uptime</h4>
                  </div>
                  <p className="text-sm text-slate-400">Enterprise-grade infrastructure with guaranteed reliability and automatic failover.</p>
                </div>
              </div>
            </div>
          </div>
