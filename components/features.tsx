          ...
          <div>
            ...
            <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
              ...
              <div className="md:w-7/12 lg:w-1/2 order-1 md:order-none max-md:text-center" data-aos="fade-down">
                {/* Content #1 */}
                <div>
                  <div className="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-3">The ultimate swaps API</div>
                </div>
                <h3 className="h3 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-3">Enterprise-Grade Swap Infrastructure</h3>
                <p className="text-lg text-slate-400 mb-8">Our API connects directly to Raydium and Meteora liquidity pools, giving your platform access to the deepest Solana liquidity available. Enable users to execute trades with minimal slippage and maximum capital efficiency.</p>
