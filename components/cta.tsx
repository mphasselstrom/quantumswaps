      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Ready to integrate seamless crypto swaps?</h2>
            <p className="text-lg text-slate-400 mb-8">Empower your users with access to deep Solana liquidity and hassle-free cross-chain swaps through our simple API integration.</p>
            <div>
